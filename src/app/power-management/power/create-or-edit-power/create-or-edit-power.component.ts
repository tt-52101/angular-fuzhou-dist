...
import { CreateOrUpdatePowerInput,PowerEditDto, PowerServiceProxy,PowerTypeEnum ,GetMenusInput} from '@shared/service-proxies/service-proxies';
    ...
    */
    init(): void {
      this._powerService.getForEdit(this.id).subscribe(result => {
        ...
        this._menuService.getPaged(formdata).subscribe(result => {
