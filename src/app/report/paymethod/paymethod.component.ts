...
import {PayMethodServiceProxy, PagedResultDtoOfPayMethodListDto, GetPayMethodResultDto,QueryData,RouteServiceProxy,	GetRoutesInput,	BoatServiceProxy,GetBoatsInput,TicketServiceProxy,GetTicketsInput} from '@shared/service-proxies/service-proxies';
...
export class  PayMethodComponent extends PagedListingComponentBase<GetPayMethodResultDto>
implements OnInit {
