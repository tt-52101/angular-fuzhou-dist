...
import {OrderSourceServiceProxy, GetOrderSourceResultDto,QueryData,SourceServiceProxy,
...
export class  SourceComponent extends PagedListingComponentBase<GetOrderSourceResultDto>
implements OnInit {
	
	constructor(
		injector: Injector,
		private _orderSourceService: OrderSourceServiceProxy,
