...
import {SellerTicketServiceProxy, SellerTicketResultDto,UserServiceProxy ,QueryData,ScheduleServiceProxy,GetSchedulesInput,
  BoatServiceProxy,GetBoatsInput,TicketServiceProxy,GetTicketsInput
