...
import { CreateOrUpdateBookInput,BookEditDto, BooksServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class CreateOrEditBookComponent
  extends ModalComponentBase
    ...
    */
    constructor(
        injector: Injector,
        private _booksService: BooksServiceProxy
    ) {
        super(injector);
    }
    ...
    */
    init(): void {
        this._booksService.getBookForEdit(this.id).subscribe(result => {
