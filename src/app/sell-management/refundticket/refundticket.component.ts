...
import {ActivityServiceProxy,GetActivitysInput,TicketDetailServiceProxy, QueryData,GetTicketDetailsInput} from '@shared/service-proxies/service-proxies';
...
export class RefundTicketComponent extends AppComponentBase implements OnInit {
  ...
  query(): void {
    ...
    if(this.queryData[0].value || this.queryData[1].value){
      ...
      var formdata1=new GetTicketDetailsInput()
      formdata1.queryData=arr
      formdata1.sorting=null
      formdata1.maxResultCount=999
      formdata1.skipCount=0
      this._ticketDetailService.getPagedPost(formdata1)
      .subscribe(result => {
