...
import {RechargeRecordServiceProxy, PagedResultDtoOfRechargeRecordListDto, RechargeRecordListDto,GetRechargeRecordsInput } from '@shared/service-proxies/service-proxies';
...
implements OnInit {
	...
	*/
	protected fetchDataList(request: PagedRequestDto,pageNumber: number,finishedCallback: Function): void {
		const formdata = new GetRechargeRecordsInput()
