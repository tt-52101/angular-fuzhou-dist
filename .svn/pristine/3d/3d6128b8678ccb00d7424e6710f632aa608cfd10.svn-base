...
export class WechatMaterialManagementComponent extends AppComponentBase
  implements OnInit {
  @ViewChild(WechatMaterialImgTextViewComponent, { static: false })
  imgTextMaterialView: WechatMaterialImgTextViewComponent;

  @ViewChild(WechatMaterialImgViewComponent, { static: false })
  imgMaterialView: WechatMaterialImgViewComponent;

  @ViewChild(WechatMaterialVoiceViewComponent, { static: false })
  voiceMaterialView: WechatMaterialVoiceViewComponent;

  @ViewChild(WechatMaterialVideoViewComponent, { static: false })
