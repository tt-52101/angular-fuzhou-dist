...
export class OrganizationUnitRolePanelComponent
  extends PagedListingComponentBase<OrganizationUnitRoleListDto>
  implements OnInit {
    ...
    this.message.confirm(
      ...
      res => {
        if (res) {
          ...
          this._organizationUnitService
            .batchRemoveRoleFromOrganizationUnit(ids, _ouId)
            .subscribe(() => {
              this.refreshGoFirstPage();
