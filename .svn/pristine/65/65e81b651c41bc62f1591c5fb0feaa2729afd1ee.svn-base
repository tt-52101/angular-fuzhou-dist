...
import { MenuFull_RootButton, KeyValuePairOfStringAndString } from '@shared/service-proxies/service-proxies';
...
export class EditMenuConfigComponent extends AppComponentBase implements OnInit {
  ...
  @Input()
  menuTypeList: KeyValuePairOfStringAndString[];
