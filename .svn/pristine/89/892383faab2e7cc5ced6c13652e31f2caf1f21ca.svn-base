...
import { CreateOrUpdateWechatAppConfigInput, WechatAppConfigEditDto, WechatAppConfigServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class CreateOrEditWechatAppConfigComponent
  ...
  */
  init(): void {
    this._wechatAppConfigService.getForEdit(this.id).subscribe(result => {
      ...
      console.log(this.wechatAppTypeList)
    });
  }
