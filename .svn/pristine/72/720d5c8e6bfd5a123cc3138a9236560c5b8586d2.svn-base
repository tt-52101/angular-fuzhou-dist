...
import { ImgShowComponent } from '@app/app-shared/components/img-show/img-show.component';
...
export class WechatAppConfigComponent
  extends PagedListingComponentBase<WechatAppConfigListDto>
  implements OnInit {
  constructor(
    injector: Injector,
  ...
  createOrEdit(id?: number): void {
    this.modalHelper
      .static(CreateOrEditWechatAppConfigComponent, { id: id })
      .subscribe(result => {
        if (result) {
          this.refresh();
        }
