...
var TravelComponent = /** @class */ (function (_super) {
    ...
    function TravelComponent(injector, _travelAgencyService) {
    ...
    TravelComponent.prototype.fetchDataList = function (request, pageNumber, finishedCallback) {
        ...
        this._travelAgencyService.getPagedStat(arr, request.sorting, request.maxResultCount, request.skipCount)
            .finally(function () {
            finishedCallback();
        })
