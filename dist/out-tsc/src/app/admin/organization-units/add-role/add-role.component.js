...
var AddRoleComponent = /** @class */ (function (_super) {
     ...
     */
    function AddRoleComponent(injector, _organizationUnitService) {
     ...
     */
    AddRoleComponent.prototype.getDataList = function (request, pageNumber, finishedCallback) {
        var _this = this;
        // 设置查询数据
    ...
    AddRoleComponent.prototype.delete = function (entity) { };
    /**
     * 添加用户到当前组织
     */
    AddRoleComponent.prototype.addUsersToOrganizationUnit = function () {
        var _this = this;
        ...
        this.saving = true;
        var input = new service_proxies_1.RolesToOrganizationUnitInput();
        input.organizationUnitId = this.organizationUnitId;
        input.roleIds = _.map(this.selectedDataItems, function (selectedMember) {
