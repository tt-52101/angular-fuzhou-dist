...
var TicketStationEnableComponent = /** @class */ (function (_super) {
    __extends(TicketStationEnableComponent, _super);
    function TicketStationEnableComponent(injector, _ticketStationEnableService) {
    ...
    */
    TicketStationEnableComponent.prototype.fetchDataList = function (request, pageNumber, finishedCallback) {
        var _this = this;
        this._ticketStationEnableService.getPaged(request.sorting, request.maxResultCount, request.skipCount)
            .finally(function () {
            finishedCallback();
        })
    ...
    * @param id 当前DTO的Id
    */
    TicketStationEnableComponent.prototype.createOrEdit = function (id) {
        var _this = this;
        this.modalHelper.static(create_or_edit_ticket_station_enable_component_1.CreateOrEditTicketStationEnableComponent, { id: id })
            .subscribe(function (result) {
            if (result) {
                _this.refresh();
            }
    ...
    */
    TicketStationEnableComponent.prototype.delete = function (entity) {
        var _this = this;
    ...
    * 批量删除
    */
    TicketStationEnableComponent.prototype.batchDelete = function () {
        var _this = this;
        ...
        abp.message.confirm(this.l('ConfirmDeleteXItemsWarningMessage', selectCount), function (res) {
            if (res) {
                ...
                _this._ticketStationEnableService.batchDelete(ids).subscribe(function () {
                    _this.refreshGoFirstPage();
                    _this.notify.success(_this.l('SuccessfullyDeleted'));
                });
            }
    ...
    * 导出为Excel表
    */
    TicketStationEnableComponent.prototype.exportToExcel = function () {
        abp.message.error('功能开发中！！！！');
        // this._ticketStationEnableService.getTicketStationEnableexportToExcel().subscribe(result => {
        // this._fileDownloadService.downloadTempFile(result);
        // });
    };
    TicketStationEnableComponent = __decorate([
        core_1.Component({
    ...
    ], TicketStationEnableComponent);
    return TicketStationEnableComponent;
}(paged_listing_component_base_1.PagedListingComponentBase));
exports.TicketStationEnableComponent = TicketStationEnableComponent;
