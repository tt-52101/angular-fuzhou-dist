...
var AccountDetailComponent = /** @class */ (function (_super) {
    ...
    function AccountDetailComponent(injector, _accountDetailService) {
    ...
    */
    AccountDetailComponent.prototype.fetchDataList = function (request, pageNumber, finishedCallback) {
        var _this = this;
        this._accountDetailService.getPaged(null, null, request.maxResultCount, request.skipCount)
            .finally(function () {
            finishedCallback();
        })
    ...
    * @param id 当前DTO的Id
    */
    AccountDetailComponent.prototype.createOrEdit = function (id) {
        var _this = this;
        this.modalHelper.static(create_or_edit_account_detail_component_1.CreateOrEditAccountDetailComponent, { id: id })
            .subscribe(function (result) {
            if (result) {
                _this.refresh();
            }
    ...
    */
    AccountDetailComponent.prototype.delete = function (entity) {
        var _this = this;
    ...
    * 批量删除
    */
    AccountDetailComponent.prototype.batchDelete = function () {
        var _this = this;
        ...
        abp.message.confirm(this.l('ConfirmDeleteXItemsWarningMessage', selectCount), function (res) {
            if (res) {
                ...
                _this._accountDetailService.batchDelete(ids).subscribe(function () {
                    _this.refreshGoFirstPage();
                    _this.notify.success(_this.l('SuccessfullyDeleted'));
                });
            }
    ...
    * 导出为Excel表
    */
    AccountDetailComponent.prototype.exportToExcel = function () {
