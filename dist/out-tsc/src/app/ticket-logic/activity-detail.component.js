...
var ActivityDetailComponent = /** @class */ (function (_super) {
    __extends(ActivityDetailComponent, _super);
    function ActivityDetailComponent(injector, _activityDetailService) {
    ...
    */
    ActivityDetailComponent.prototype.fetchDataList = function (request, pageNumber, finishedCallback) {
        var _this = this;
        this._activityDetailService.getPaged([], request.sorting, request.maxResultCount, request.skipCount)
            .finally(function () {
            finishedCallback();
        })
    ...
    * @param id 当前DTO的Id
    */
    ActivityDetailComponent.prototype.createOrEdit = function (id) {
        var _this = this;
        this.modalHelper.static(create_or_edit_activity_detail_component_1.CreateOrEditActivityDetailComponent, { id: id })
            .subscribe(function (result) {
            if (result) {
                _this.refresh();
            }
    ...
    */
    ActivityDetailComponent.prototype.delete = function (entity) {
        var _this = this;
    ...
    * 批量删除
    */
    ActivityDetailComponent.prototype.batchDelete = function () {
        var _this = this;
        ...
        abp.message.confirm(this.l('ConfirmDeleteXItemsWarningMessage', selectCount), function (res) {
            if (res) {
                ...
                _this._activityDetailService.batchDelete(ids).subscribe(function () {
                    _this.refreshGoFirstPage();
                    _this.notify.success(_this.l('SuccessfullyDeleted'));
                });
            }
    ...
    * 导出为Excel表
    */
    ActivityDetailComponent.prototype.exportToExcel = function () {
