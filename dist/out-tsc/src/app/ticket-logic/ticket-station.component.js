...
var TicketStationComponent = /** @class */ (function (_super) {
    __extends(TicketStationComponent, _super);
    function TicketStationComponent(injector, _ticketStationService) {
    ...
    */
    TicketStationComponent.prototype.fetchDataList = function (request, pageNumber, finishedCallback) {
        var _this = this;
        this._ticketStationService.getPaged(null, request.sorting, request.maxResultCount, request.skipCount)
            .finally(function () {
            finishedCallback();
        })
    ...
    * @param id 当前DTO的Id
    */
    TicketStationComponent.prototype.createOrEdit = function (id) {
        var _this = this;
        this.modalHelper.static(create_or_edit_ticket_station_component_1.CreateOrEditTicketStationComponent, { id: id })
            .subscribe(function (result) {
            if (result) {
                _this.refresh();
            }
    ...
    */
    TicketStationComponent.prototype.delete = function (entity) {
        var _this = this;
    ...
    * 批量删除
    */
    TicketStationComponent.prototype.batchDelete = function () {
        var _this = this;
        ...
        abp.message.confirm(this.l('ConfirmDeleteXItemsWarningMessage', selectCount), function (res) {
            if (res) {
                ...
                _this._ticketStationService.batchDelete(ids).subscribe(function () {
                    _this.refreshGoFirstPage();
                    _this.notify.success(_this.l('SuccessfullyDeleted'));
                });
            }
    ...
    * 导出为Excel表
    */
    TicketStationComponent.prototype.exportToExcel = function () {
        abp.message.error('功能开发中！！！！');
        // this._ticketStationService.getTicketStationexportToExcel().subscribe(result => {
        // this._fileDownloadService.downloadTempFile(result);
        // });
    };
    TicketStationComponent = __decorate([
        core_1.Component({
    ...
    return TicketStationComponent;
}(paged_listing_component_base_1.PagedListingComponentBase));
exports.TicketStationComponent = TicketStationComponent;
