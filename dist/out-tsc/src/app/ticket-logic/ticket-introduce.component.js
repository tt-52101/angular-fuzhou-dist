...
var TicketIntroduceComponent = /** @class */ (function (_super) {
    __extends(TicketIntroduceComponent, _super);
    function TicketIntroduceComponent(injector, _ticketIntroduceService) {
    ...
    */
    TicketIntroduceComponent.prototype.fetchDataList = function (request, pageNumber, finishedCallback) {
        var _this = this;
        this._ticketIntroduceService.getPaged(null, null, request.maxResultCount, request.skipCount)
            .finally(function () {
            finishedCallback();
        })
    ...
    * @param id 当前DTO的Id
    */
    TicketIntroduceComponent.prototype.createOrEdit = function (id) {
        var _this = this;
        this.modalHelper.static(create_or_edit_ticket_introduce_component_1.CreateOrEditTicketIntroduceComponent, { id: id })
            .subscribe(function (result) {
            if (result) {
                _this.refresh();
            }
    ...
    */
    TicketIntroduceComponent.prototype.delete = function (entity) {
        var _this = this;
    ...
    * 批量删除
    */
    TicketIntroduceComponent.prototype.batchDelete = function () {
        var _this = this;
        ...
        abp.message.confirm(this.l('ConfirmDeleteXItemsWarningMessage', selectCount), function (res) {
            if (res) {
                ...
                _this._ticketIntroduceService.batchDelete(ids).subscribe(function () {
                    _this.refreshGoFirstPage();
                    _this.notify.success(_this.l('SuccessfullyDeleted'));
                });
            }
    ...
    * 导出为Excel表
    */
    TicketIntroduceComponent.prototype.exportToExcel = function () {
        abp.message.error('功能开发中！！！！');
        // this._ticketIntroduceService.getTicketIntroduceexportToExcel().subscribe(result => {
        // this._fileDownloadService.downloadTempFile(result);
        // });
    };
    TicketIntroduceComponent = __decorate([
        core_1.Component({
    ...
    return TicketIntroduceComponent;
}(paged_listing_component_base_1.PagedListingComponentBase));
exports.TicketIntroduceComponent = TicketIntroduceComponent;
