...
var TicketDetailHistoryComponent = /** @class */ (function (_super) {
    __extends(TicketDetailHistoryComponent, _super);
    function TicketDetailHistoryComponent(injector, _ticketDetailHistoryService) {
    ...
    */
    TicketDetailHistoryComponent.prototype.fetchDataList = function (request, pageNumber, finishedCallback) {
        var _this = this;
        this._ticketDetailHistoryService.getPaged(this.queryData, request.sorting, request.maxResultCount, request.skipCount)
            .finally(function () {
            finishedCallback();
        })
    ...
    * @param id 当前DTO的Id
    */
    TicketDetailHistoryComponent.prototype.createOrEdit = function (id) {
        var _this = this;
        this.modalHelper.static(create_or_edit_ticket_detail_history_component_1.CreateOrEditTicketDetailHistoryComponent, { id: id })
            .subscribe(function (result) {
            if (result) {
                _this.refresh();
            }
    ...
    */
    TicketDetailHistoryComponent.prototype.delete = function (entity) {
        var _this = this;
    ...
    * 批量删除
    */
    TicketDetailHistoryComponent.prototype.batchDelete = function () {
        var _this = this;
        ...
        abp.message.confirm(this.l('ConfirmDeleteXItemsWarningMessage', selectCount), function (res) {
            if (res) {
                ...
                _this._ticketDetailHistoryService.batchDelete(ids).subscribe(function () {
                    _this.refreshGoFirstPage();
                    _this.notify.success(_this.l('SuccessfullyDeleted'));
                });
            }
    ...
    * 导出为Excel表
    */
    TicketDetailHistoryComponent.prototype.exportToExcel = function () {
        abp.message.error('功能开发中！！！！');
        // this._ticketDetailHistoryService.getTicketDetailHistoryexportToExcel().subscribe(result => {
        // this._fileDownloadService.downloadTempFile(result);
        // });
    };
    TicketDetailHistoryComponent = __decorate([
        core_1.Component({
    ...
    return TicketDetailHistoryComponent;
}(paged_listing_component_base_1.PagedListingComponentBase));
exports.TicketDetailHistoryComponent = TicketDetailHistoryComponent;
