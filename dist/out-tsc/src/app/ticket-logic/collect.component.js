...
var CollectComponent = /** @class */ (function (_super) {
    __extends(CollectComponent, _super);
    function CollectComponent(injector, _accountService, _ticketaccountService, _payMethodService, _accountDetailService, _ticketDetailService) {
    ...
    CollectComponent.prototype.search = function () {
        var _this = this;
    ...
    CollectComponent.prototype.fetchDataList = function (request, pageNumber, finishedCallback) {
        var _this = this;
        var formdata = new service_proxies_1.GetAccountsInput();
        var arr = [];
        for (var i = this.queryData.length - 1; i >= 0; i--) {
    ...
    CollectComponent.prototype.getpayMethod = function () {
        var _this = this;
    ...
    CollectComponent.prototype.datechange = function ($event) {
        this.queryData[3].value = $event[0];
        this.queryData[4].value = $event[1];
    };
    CollectComponent.prototype.close = function () {
        this.visible = false;
    };
    CollectComponent.prototype.collect = function () {
        var _this = this;
        ...
        abp.message.confirm(this.l('ConfirmCollectXItemsWarningMessage', selectCount), function (res) {
            if (res) {
                var ids = _.map(_this.selectedDataItems, 'id');
                _this._accountService.collectAccounts(ids).subscribe(function (result) {
                    if (result.resultCode == '000') {
                        _this.notify.success(_this.l('SuccessfullyCollect'));
    ...
    CollectComponent.prototype.open = function (account, id) {
        var _this = this;
