...
var BookComponent = /** @class */ (function (_super) {
    ...
    function BookComponent(injector, _booksService) {
     ...
     */
    BookComponent.prototype.fetchDataList = function (request, pageNumber, finishedCallback) {
        var _this = this;
        this._booksService
            .getPagedBook(request.sorting, request.maxResultCount, request.skipCount)
            .finally(function () {
            finishedCallback();
        })
     ...
     * @param id 当前DTO的Id
     */
    BookComponent.prototype.createOrEdit = function (id) {
        var _this = this;
        this.modalHelper.static(create_or_edit_book_component_1.CreateOrEditBookComponent, { id: id }).subscribe(function (result) {
            if (result) {
                _this.refresh();
            }
        }, function (err) {
     ...
     */
    BookComponent.prototype.delete = function (entity) {
        var _this = this;
        this._booksService.deleteBook(entity.id).subscribe(function () {
            /**
     ...
     * 批量删除
     */
    BookComponent.prototype.batchDelete = function () {
        var _this = this;
        ...
        abp.message.confirm(this.l('ConfirmDeleteXItemsWarningMessage', selectCount), function (res) {
            if (res) {
                ...
                _this._booksService.batchDeleteBook(ids).subscribe(function () {
                    _this.refreshGoFirstPage();
                    _this.notify.success(_this.l('SuccessfullyDeleted'));
                }, function (err) {
                    _this.notify.error(_this.l('DefaultErrorMessage'));
     ...
     * 导出为Excel表
     */
    BookComponent.prototype.exportToExcel = function () {
    ...
    BookComponent = __decorate([
        ...
        __metadata("design:paramtypes", [core_1.Injector, service_proxies_1.BooksServiceProxy])
    ], BookComponent);
