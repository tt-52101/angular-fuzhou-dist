...
var RechargeRecordComponent = /** @class */ (function (_super) {
    __extends(RechargeRecordComponent, _super);
    function RechargeRecordComponent(injector, _rechargeRecordService) {
    ...
    */
    RechargeRecordComponent.prototype.fetchDataList = function (request, pageNumber, finishedCallback) {
        var _this = this;
        var formdata = new service_proxies_1.GetRechargeRecordsInput();
        ...
        this._rechargeRecordService.getPagedForPost(formdata)
            .finally(function () {
            finishedCallback();
        })
    ...
    * @param id 当前DTO的Id
    */
    RechargeRecordComponent.prototype.createOrEdit = function (id) {
        var _this = this;
        this.modalHelper.static(create_or_edit_recharge_record_component_1.CreateOrEditRechargeRecordComponent, { id: id })
            .subscribe(function (result) {
            if (result) {
                _this.refresh();
            }
    ...
    */
    RechargeRecordComponent.prototype.delete = function (entity) {
        var _this = this;
    ...
    * 批量删除
    */
    RechargeRecordComponent.prototype.batchDelete = function () {
        var _this = this;
        ...
        abp.message.confirm(this.l('ConfirmDeleteXItemsWarningMessage', selectCount), function (res) {
            if (res) {
                ...
                _this._rechargeRecordService.batchDelete(ids).subscribe(function () {
                    _this.refreshGoFirstPage();
                    _this.notify.success(_this.l('SuccessfullyDeleted'));
                });
            }
    ...
    * 导出为Excel表
    */
    RechargeRecordComponent.prototype.exportToExcel = function () {
