...
var TravelAgencyComponent = /** @class */ (function (_super) {
    __extends(TravelAgencyComponent, _super);
    function TravelAgencyComponent(injector, _travelAgencyService) {
    ...
    */
    TravelAgencyComponent.prototype.fetchDataList = function (request, pageNumber, finishedCallback) {
        var _this = this;
    ...
    * @param id 当前DTO的Id
    */
    TravelAgencyComponent.prototype.createOrEdit = function (id) {
        var _this = this;
        this.modalHelper.static(create_or_edit_travel_agency_component_1.CreateOrEditTravelAgencyComponent, { id: id })
            .subscribe(function (result) {
            if (result) {
                _this.refresh();
            }
    ...
    */
    TravelAgencyComponent.prototype.delete = function (entity) {
        var _this = this;
    ...
    * 批量删除
    */
    TravelAgencyComponent.prototype.batchDelete = function () {
        var _this = this;
        ...
        abp.message.confirm(this.l('ConfirmDeleteXItemsWarningMessage', selectCount), function (res) {
            if (res) {
                ...
                _this._travelAgencyService.batchDelete(ids).subscribe(function () {
                    _this.refreshGoFirstPage();
                    _this.notify.success(_this.l('SuccessfullyDeleted'));
                });
            }
    ...
    * 导出为Excel表
    */
    TravelAgencyComponent.prototype.exportToExcel = function () {
        abp.message.error('功能开发中！！！！');
        // this._travelAgencyService.getTravelAgencyexportToExcel().subscribe(result => {
        // this._fileDownloadService.downloadTempFile(result);
        // });
    };
    TravelAgencyComponent = __decorate([
        core_1.Component({
    ...
    return TravelAgencyComponent;
}(paged_listing_component_base_1.PagedListingComponentBase));
exports.TravelAgencyComponent = TravelAgencyComponent;
