...
var create_or_edit_menu_component_1 = require("./create-or-edit-menu/create-or-edit-menu.component");
//import { AppConsts } from '@shared/AppConsts';
//  import { FileDownloadService } from '@shared/utils/file-download.service';
var abc_1 = require("@delon/abc");
var MenuComponent = /** @class */ (function (_super) {
    __extends(MenuComponent, _super);
    function MenuComponent(injector, _menuService, _reuseTabService) {
        var _this = _super.call(this, injector) || this;
        _this._menuService = _menuService;
        _this._reuseTabService = _reuseTabService;
        _this._reuseTabService.title = _this.l('菜单管理');
        return _this;
    }
    /**
     * 获取后端数据列表信息
     ...
     */
    MenuComponent.prototype.fetchDataList = function (request, pageNumber, finishedCallback) {
        var _this = this;
        this._menuService.getPaged(null, 999, 0)
            .finally(function () {
            finishedCallback();
        })
     ...
     * @param id 当前DTO的Id
     */
    MenuComponent.prototype.createOrEdit = function (id) {
        var _this = this;
        this.modalHelper.static(create_or_edit_menu_component_1.CreateOrEditMenuComponent, { id: id })
            .subscribe(function (result) {
            if (result) {
                _this.refresh();
            }
     ...
     */
    MenuComponent.prototype.delete = function (entity) {
        var _this = this;
     ...
     * 批量删除
     */
    MenuComponent.prototype.batchDelete = function () {
        var _this = this;
        ...
        abp.message.confirm(this.l('ConfirmDeleteXItemsWarningMessage', selectCount), function (res) {
            if (res) {
                ...
                _this._menuService.batchDelete(ids).subscribe(function () {
                    _this.refreshGoFirstPage();
                    _this.notify.success(_this.l('SuccessfullyDeleted'));
                });
            }
     ...
     * 导出为Excel表
     */
    MenuComponent.prototype.exportToExcel = function () {
