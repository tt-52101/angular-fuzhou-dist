...
var BranchComponent = /** @class */ (function (_super) {
    ...
    function BranchComponent(injector, _branchService) {
    ...
    */
    BranchComponent.prototype.fetchDataList = function (request, pageNumber, finishedCallback) {
        var _this = this;
    ...
    * @param id 当前DTO的Id
    */
    BranchComponent.prototype.createOrEdit = function (id) {
        var _this = this;
        this.modalHelper.static(create_or_edit_branch_component_1.CreateOrEditBranchComponent, { id: id })
            .subscribe(function (result) {
            if (result) {
                _this.refresh();
            }
    ...
    */
    BranchComponent.prototype.delete = function (entity) {
        var _this = this;
    ...
    * 批量删除
    */
    BranchComponent.prototype.batchDelete = function () {
        var _this = this;
        ...
        abp.message.confirm(this.l('ConfirmDeleteXItemsWarningMessage', selectCount), function (res) {
            if (res) {
                ...
                _this._branchService.batchDelete(ids).subscribe(function () {
                    _this.refreshGoFirstPage();
                    _this.notify.success(_this.l('SuccessfullyDeleted'));
                });
            }
    ...
    * 导出为Excel表
    */
    BranchComponent.prototype.exportToExcel = function () {
