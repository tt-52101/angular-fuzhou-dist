...
var RouteComponent = /** @class */ (function (_super) {
    ...
    function RouteComponent(injector, _routeService) {
    ...
    * @param id 当前DTO的Id
    */
    RouteComponent.prototype.createOrEdit = function (id) {
        var _this = this;
        this.modalHelper.static(create_or_edit_route_component_1.CreateOrEditRouteComponent, { id: id })
            .subscribe(function (result) {
            if (result) {
                _this.refresh();
            }
    ...
    */
    RouteComponent.prototype.delete = function (entity) {
        var _this = this;
    ...
    * 批量删除
    */
    RouteComponent.prototype.batchDelete = function () {
        var _this = this;
        ...
        abp.message.confirm(this.l('ConfirmDeleteXItemsWarningMessage', selectCount), function (res) {
            if (res) {
                ...
                _this._routeService.batchDelete(ids).subscribe(function () {
                    _this.refreshGoFirstPage();
                    _this.notify.success(_this.l('SuccessfullyDeleted'));
                });
            }
    ...
    * 导出为Excel表
    */
    RouteComponent.prototype.exportToExcel = function () {
