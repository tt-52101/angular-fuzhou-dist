...
var BoatComponent = /** @class */ (function (_super) {
    __extends(BoatComponent, _super);
    function BoatComponent(injector, _boatService) {
    ...
    */
    BoatComponent.prototype.fetchDataList = function (request, pageNumber, finishedCallback) {
        var _this = this;
    ...
    * @param id 当前DTO的Id
    */
    BoatComponent.prototype.createOrEdit = function (id) {
        var _this = this;
        this.modalHelper.static(create_or_edit_boat_component_1.CreateOrEditBoatComponent, { id: id })
            .subscribe(function (result) {
            if (result) {
                _this.refresh();
            }
    ...
    */
    BoatComponent.prototype.delete = function (entity) {
        var _this = this;
        this._boatService.delete(entity.id)
            .subscribe(function () {
            /**
    ...
    * 批量删除
    */
    BoatComponent.prototype.batchDelete = function () {
        var _this = this;
        ...
        abp.message.confirm(this.l('ConfirmDeleteXItemsWarningMessage', selectCount), function (res) {
            if (res) {
                ...
                _this._boatService.batchDelete(ids).subscribe(function () {
                    _this.refreshGoFirstPage();
                    _this.notify.success(_this.l('SuccessfullyDeleted'));
                });
            }
    ...
    * 导出为Excel表
    */
    BoatComponent.prototype.exportToExcel = function () {
        abp.message.error('功能开发中！！！！');
        // this._boatService.getBoatexportToExcel().subscribe(result => {
